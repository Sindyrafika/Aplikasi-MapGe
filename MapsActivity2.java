...
import com.example.geothermalversi20.databinding.ActivityMaps2Binding;
...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    TextView button2;
    TextView button3;
    TextView geo01, geo02, geo03, geo04, geo05, geo06, geo07, geo08, geo09, geo10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        geo02 = findViewById(R.id.geothermal02);
        geo02.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        geo03 = findViewById(R.id.geothermal03);
        geo03.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo04 = findViewById(R.id.geothermal04);
        geo04.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo05 = findViewById(R.id.geothermal05);
        geo05.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo06 = findViewById(R.id.geothermal06);
        geo06.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo07 = findViewById(R.id.geothermal07);
        geo07.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo08 = findViewById(R.id.geothermal08);
        geo08.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo09 = findViewById(R.id.geothermal09);
        geo09.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
        ...
        geo10 = findViewById(R.id.geothermal10);
        geo10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                drawerLayout.closeDrawer(GravityCompat.START);
                mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(-7.21955, 109.17016), 11));
            }
        });
    ...
    protected void onPause() {
        super.onPause();
        MainActivity.closeDrawer(drawerLayout);
        MainActivity.closeRightDrawer(rightdrawer);
    }
    ...
    public void popupbutton(View view) {
        ...
        PopupWindow popupWindow = new PopupWindow(viewpopup, 900, 500, true);
