...
public class Dashboard_Sulawesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_sulawesi);
    ...
    public void Sulawesi(View view) { recreate();}

    public void Papua(View view) {
        MainActivity.redirectActivity(this, Dashboard_Papua.class);}
